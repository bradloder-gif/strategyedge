          ...
          <RevealEl className="lg:col-span-1">
            <div className="sticky top-28">
              ...
              <div className="space-y-4">
                {["Delivers practical, actionable recommendations", "Excellent CEO and Board level communication", "Combines challenge with hands-on involvement"].map((attr) => (
                  <div key={attr} className="flex gap-3">
                    ...
                    <p style={{ fontFamily: "'Barlow', sans-serif", fontSize: "0.875rem", fontWeight: 400, color: "oklch(0.38 0.03 264)", lineHeight: 1.65 }}>{attr}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="p-6 h-full transition-all duration-300 cursor-pointer" style={boxStyle("current")} onMouseEnter={() => setHoveredBox("current")} onMouseLeave={() => setHoveredBox(null)}>
                  ...
                  <ul className="space-y-2">
                    {currentPositions.map((pos) => (
                      <li key={pos} style={{ fontFamily: "'Barlow', sans-serif", fontSize: "0.875rem", fontWeight: 400, color: textColor("current", "oklch(0.42 0.03 264)", "white"), lineHeight: 1.6, transition: "color 0.3s" }}>{pos}</li>
                    ))}
                  </ul>
                  <div className="mt-5 pt-4" style={{ borderTop: hoveredBox === "current" ? "1px solid rgba(255,255,255,0.15)" : "1px solid oklch(0.88 0.012 264)" }}>
                    <h4 style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: "0.78rem", letterSpacing: "0.14em", textTransform: "uppercase", color: textColor("current", "oklch(0.52 0.14 258)", "rgba(255,255,255,0.7)"), marginBottom: "0.75rem", transition: "color 0.3s" }}>Prior Consulting</h4>
                    <ul className="space-y-2">
                      {priorConsulting.map((pos) => (
                        <li key={pos} style={{ fontFamily: "'Barlow', sans-serif", fontSize: "0.875rem", fontWeight: 300, color: textColor("current", "oklch(0.42 0.03 264)", "rgba(255,255,255,0.75)"), lineHeight: 1.6, transition: "color 0.3s" }}>{pos}</li>
                      ))}
                    </ul>
                  </div>
                </div>
              ...
              <RevealEl delay={200}>
                <div className="p-6 h-full transition-all duration-300 cursor-pointer" style={boxStyle("industry")} onMouseEnter={() => setHoveredBox("industry")} onMouseLeave={() => setHoveredBox(null)}>
                  <div className="flex items-center gap-3 mb-4">
                    <Award size={16} style={{ color: textColor("industry", "oklch(0.52 0.14 258)", "rgba(255,255,255,0.7)") }} />
                  ...
                  <ul className="space-y-2">
                    {industryExperience.map((pos) => (
                      <li key={pos} className="flex gap-2">
                        <span className="flex-shrink-0 mt-2 w-1 h-1 rounded-full" style={{ backgroundColor: textColor("industry", "oklch(0.52 0.14 258)", "rgba(255,255,255,0.5)") }} />
                        <span style={{ fontFamily: "'Barlow', sans-serif", fontSize: "0.8125rem", fontWeight: 300, color: textColor("industry", "oklch(0.42 0.03 264)", "rgba(255,255,255,0.85)"), lineHeight: 1.65, transition: "color 0.3s" }}>{pos}</span>
                      </li>
                    ))}
                  </ul>
                </div>
              ...
              <RevealEl delay={250}>
                <div className="p-6 h-full transition-all duration-300 cursor-pointer" style={boxStyle("board")} onMouseEnter={() => setHoveredBox("board")} onMouseLeave={() => setHoveredBox(null)}>
                  <div className="flex items-center gap-3 mb-4">
                    <Award size={16} style={{ color: textColor("board", "oklch(0.52 0.14 258)", "rgba(255,255,255,0.7)") }} />
                  ...
                  <ul className="space-y-2">
                    {boardSeats.map((seat) => (
                      <li key={seat} className="flex gap-2">
                        <span className="flex-shrink-0 mt-2 w-1 h-1 rounded-full" style={{ backgroundColor: textColor("board", "oklch(0.52 0.14 258)", "rgba(255,255,255,0.5)") }} />
                        <span style={{ fontFamily: "'Barlow', sans-serif", fontSize: "0.8125rem", fontWeight: 300, color: textColor("board", "oklch(0.42 0.03 264)", "rgba(255,255,255,0.85)"), lineHeight: 1.65, transition: "color 0.3s" }}>{seat}</span>
                      </li>
                    ))}
                  </ul>
                </div>
